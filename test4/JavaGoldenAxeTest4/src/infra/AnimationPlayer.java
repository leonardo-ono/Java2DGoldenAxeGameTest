...
public class AnimationPlayer {
    ...
    public AnimationPlayer(String spriteSheetRes, String collidersRes, String ... animationResources) {
        ...
        for (String animationResource : animationResources) {
            if (animationResource.endsWith("sprite_sheet.txt")) {
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (data[0].equals("sprite")) {
                    ...
                    Sprite sprite = new Sprite(name, subimage, ox, oy, originalDirection, rectangle, colliders);
        ...
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (data[0].equals("name")) {
                    ...
                    BufferedImage subimage = spriteSheet.getSubimage(x, y, width, height);
                    Rectangle rectangle = new Rectangle(x, y, width, height);
                    Sprite sprite = new Sprite("", subimage, ox, oy, Direction.IDLE, rectangle, colliders);
                    spritesList.add(sprite);
                }
            }
            br.close();
