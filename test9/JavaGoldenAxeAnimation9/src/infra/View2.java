...
public class View2 extends JPanel implements KeyListener, MouseListener {
    ...
    private String projectPath = "D:/golden_axe/JavaGoldenAxeAnimation9/src";
    
    //private static String file = "/player/gilius/sprite_sheet.txt";
    //private String spriteFile = "/player/gilius/gilius.png";

    private static String file = "/enemy/longmoan/sprite_sheet.txt";
    private String spriteFile = "/enemy/longmoan/longmoan.png";
    
    //private static String file = "/enemy/heninger/sprite_sheet.txt";
    //private String spriteFile = "/enemy/heninger/heninger.png";

    //private static String file = "/magic/gilius/sprite_sheet.txt";
    //private String spriteFile = "/magic/gilius/lightning_1.png";

    //private static String file = "/beasts/chicken_leg/sprite_sheet.txt";
    //private String spriteFile = "/beasts/chicken_leg/chicken_leg.png";
    ...
    private void saveSpriteSheet() {
        try {
            PrintWriter pw = new PrintWriter(projectPath + file);
