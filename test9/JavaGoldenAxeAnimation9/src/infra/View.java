...
public class View extends JPanel implements MouseListener {
    ...
    public View() {
        try {
            //image = ImageIO.read(getClass().getResourceAsStream("/game/title.png"));
            //image = ImageIO.read(getClass().getResourceAsStream("/player/gilius/gilius.png"));
            image = ImageIO.read(getClass().getResourceAsStream("/enemy/longmoan/longmoan.png"));
            //image = ImageIO.read(getClass().getResourceAsStream("/enemy/heninger/heninger.png"));
            //image = ImageIO.read(getClass().getResourceAsStream("/beasts/chicken_leg/chicken_leg.png"));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            frame.setTitle("Java Sprite Extractor");
    ...
    public void mousePressed(MouseEvent e) {
        try {
            ...
            System.out.println("sprite " + rectangle.x + " " + rectangle.y + " " + rectangle.width + " " + rectangle.height + " 0 0");
