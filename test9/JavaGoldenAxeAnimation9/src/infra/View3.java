...
public class View3 extends JPanel implements KeyListener, MouseListener {
    ...
    public static final String PATH = "D:\\golden_axe\\JavaGoldenAxeAnimation9\\";
            
//    public static final String FILE = PATH + "src\\player\\gilius\\colliders.txt";
//    public static final String IMAGE_FILE = "/player/gilius/gilius.png";

    //public static final String FILE = PATH + "src\\enemy\\longmoan\\colliders.txt";
    //public static final String IMAGE_FILE = "/enemy/longmoan/longmoan.png";
    
    //public static final String FILE = PATH + "src\\enemy\\heninger\\colliders.txt";
    //public static final String IMAGE_FILE = "/enemy/heninger/heninger.png";

    //public static final String FILE = PATH + "src\\magic\\gilius\\colliders.txt";
    //public static final String IMAGE_FILE = "/magic/gilius/lightning_1.png";

    public static final String FILE = PATH + "src\\beasts\\chicken_leg\\colliders.txt";
    public static final String IMAGE_FILE = "/beasts/chicken_leg/chicken_leg.png";
