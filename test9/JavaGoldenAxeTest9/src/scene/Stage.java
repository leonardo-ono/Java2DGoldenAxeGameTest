...
public class Stage extends Scene {
    ...
    public void init() {
        ...
        entities.add(new Beast1(this, new PlayerControl(1), player1, 50, 270, 0));
        
        //Player1 p1Tmp = new Player1(this, new PlayerControl(1));
        //p1Tmp.init();
        //Beast1 b1Tmp = new Beast1(this, new PlayerControl(1));
        //entities.add(player1 = b1Tmp);
        //b1Tmp.mount(p1Tmp);
    ...
    public void update() {
        ...
        if (Input.isKeyJustPressed(KeyEvent.VK_3)) {
            Lightning2 lighting = new Lightning2(this);
            addEntity(lighting);
        }
                                ...
                                if (yyy.getType() == Collider.Type.BODY) {
                                    if (yyy.intersects(xxx) && Math.abs(p1.getZ() - p2.getZ()) < 16) {
                                        ...
                                        if (xxx.getType() == Collider.Type.ATTACK) {
                                            ...
                                            // TODO the beast attack hitbox is colliding with body collider of mouting caracter
                                            if (p1 instanceof Beast1) {
                                                Beast1 b1 = (Beast1) p1;
                                                if (b1.getMountedBy() != null && p2 == b1.getMountedBy()) {
                                                    return;
                                                }
                                            }
                                            // hit
