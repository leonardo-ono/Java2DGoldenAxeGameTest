...
public class Enemy1 extends Player1 {
    ...
    public Enemy1(Stage stage, PlayerControl control, Player1 player, int x, int z, int y) {
        super(stage, control);
...
//        }
    ...
    private class Dying extends State {
        ...
        public Dying() {
            super(stateManager, "dying", Enemy1.this);
        }
    ...
    private class Dead extends State {
        ...
        public Dead() {
            super(stateManager, "dead", Enemy1.this);
        }
    ...
    private class Resting extends State {
        ...
        public Resting() {
            super(stateManager, "resting", Enemy1.this);
        }
    ...
    private class Mounting extends State {
        ...
        public Mounting() {
            super(stateManager, "mounting", Enemy1.this);
        }
    ...
    private class Mounted extends State {
        ...
        public Mounted() {
            super(stateManager, "mounted", Enemy1.this);
        }
