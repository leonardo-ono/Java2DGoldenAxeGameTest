...
//    }
    ...
    private class Throwing extends State {
        ...
        private final MyPoint pTmp = new AnimationPlayer.MyPoint("tmp", 0, 0);
    ...
    private class Resting extends State {
        ...
        public Resting() {
            super(stateManager, "resting", Player1.this);
        }
    ...
    private class Mounting extends State {
        ...
        public Mounting() {
            super(stateManager, "mounting", Player1.this);
        }
    ...
    private class Mounted extends State {
        ...
        public Mounted() {
            super(stateManager, "mounted", Player1.this);
        }
