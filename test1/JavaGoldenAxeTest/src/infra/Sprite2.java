...
public class Sprite2 {
    ...
    public Sprite2(String res, int originX, int originY) {
        this.originX = originX;
        this.originY = originY;
        try {
            image = ImageIO.read(getClass().getResourceAsStream("/res/" + res + ".png"));
        } catch (IOException ex) {
            Logger.getLogger(Sprite2.class.getName()).log(Level.SEVERE, null, ex);
            System.exit(-1);
        }
    }
    ...
    public boolean collides(int bx, int by, Sprite2 attackSprite, int ax, int ay, Collider colliderResult) {
