...
public class Camera {
    ...
    private static double maxX = 276;
    ...
    public static double getLockedMaxX() {
        return maxX;
    }
    
    public static double getMaxX() {
        return locked ? maxX : player1.getX() > player2.getX() 
    ...
    public static void update() {
        ...
        int maxY = Terrain.getMaxY((int) (x + Settings.CANVAS_WIDTH));
        if (y + Settings.CANVAS_HEIGHT > maxY) {
            y = maxY - Settings.CANVAS_HEIGHT;
        }
    }
